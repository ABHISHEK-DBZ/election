 ...
 * Optimized with Suspense boundaries and dynamic imports for peak efficiency.
 */
...
const SectionSkeleton = () => (
  <div className="h-96 w-full animate-pulse bg-slate-100 dark:bg-slate-800/50 rounded-[3rem] flex items-center justify-center">
